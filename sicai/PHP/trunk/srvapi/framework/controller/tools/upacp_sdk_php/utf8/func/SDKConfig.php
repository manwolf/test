...
// 签名证书路径
const SDK_SIGN_CERT_PATH = '../../PM_898110282990734_acp.pfx';

// 签名证书密码
 const SDK_SIGN_CERT_PWD = 'etyf168';
...
if (defined ( 'TestVersion' )) { # 测试环境
	// 前台通知地址 (商户自行配置通知地址)
	define("SDK_FRONT_NOTIFY_URL","http://testapi.e-teacher.cn/srvapi/framework/controller/tools/upacp_sdk_php/demo/utf8/Jump.php");
	// 后台通知地址 (商户自行配置通知地址)
	define("SDK_BACK_NOTIFY_URL","http://testapi.e-teacher.cn/srvapi/framework/controller/tools/upacp_sdk_php/demo/utf8/BackReceive.php");
}else{
	// 前台通知地址 (商户自行配置通知地址)
	define("SDK_FRONT_NOTIFY_URL","http://api.e-teacher.cn/srvapi/framework/controller/tools/upacp_sdk_php/demo/utf8/Jump.php");
	// 后台通知地址 (商户自行配置通知地址)
	define("SDK_BACK_NOTIFY_URL","http://api.e-teacher.cn/srvapi/framework/controller/tools/upacp_sdk_php/demo/utf8/BackReceive.php");
}
//文件下载目录 
const SDK_FILE_DOWN_PATH = '/home/chenhr/file_for_unionPay/';

//日志 目录 
const SDK_LOG_FILE_PATH = '/home/chenhr/logs_for_unionPay/';
