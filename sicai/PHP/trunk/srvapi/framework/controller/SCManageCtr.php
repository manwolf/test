<?php
		...
		public function __construct(){
				$this->tablename = 'sc_admin_info';
	}
	//市场管理员登录
		function scAdminLand()
	{
		$msg = new responseMsg ();
		...
		$sc_telephone=$newrow['sc_telephone'];
 	    ...
 	    $verify = new encrypt();
 	    $result = $verify->login('sc_telephone',$sc_telephone,'sc_pwd',$sc_pwd,'sc_admin_info');
 	    if($result){
 	    	$msg->ResponseMsg ( 0, '登录成功', $result, 0, $prefixJS );
 	    
 	    }else{
 	    	$msg->ResponseMsg ( 1, '账号密码错误！', $result, 0, $prefixJS );
...
// 	echo 22;
// 	exit;
	if($sc_city==null || $sc_telephone==null ||$sc_pwd==null)
	{
	...
	$addSql = 'insert  sc_user_info set ';
