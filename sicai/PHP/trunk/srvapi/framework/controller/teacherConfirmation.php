...
class teacherConfirmation extends crudCtr {
	...
	function queryOrderInfo() {
		...
		if (! $newrow) {
			...
			// 教师查询所有订单
			$querySql = 'select b.pay_done,b.create_time,d.class_count,c.teacher_name,a.user_name,b.order_type,b.class_content,b.order_date,b.order_time,b.order_address,b.tid as order_tid
                         from user_info a,order_list b,teacher_info c,class_discount d
                         where c.tid=b.teacher_tid and a.tid=b.user_tid and c.tid=' . $tid . ' group by b.tid'; //
