...
class Smarty_Internal_Template extends Smarty_Internal_Data
{
    ...
    {
        return $this->template_filepath === null ? $this->template_filepath = $this->resource_object->getTemplateFilepath($this) : $this->template_filepath;
    }
    ...
    {
        return $this->template_timestamp === null ? $this->template_timestamp = $this->resource_object->getTemplateTimestamp($this) : $this->template_timestamp;
    }
    ...
    {
        return $this->compiled_filepath === null ? ($this->compiled_filepath = ! $this->resource_object->isEvaluated ? $this->resource_object->getCompiledFilepath($this) : false) : $this->compiled_filepath;
    }
    ...
    {
        return $this->compiled_timestamp === null ? ($this->compiled_timestamp = (! $this->resource_object->isEvaluated && file_exists($this->getCompiledFilepath())) ? filemtime($this->getCompiledFilepath()) : false) : $this->compiled_timestamp;
    }
    ...
    public function compileTemplateSource()
    {
        ...
        unset($this->compiler_object->parser->root_buffer, $this->compiler_object->parser->current_buffer, $this->compiler_object->parser, $this->compiler_object->lex, $this->compiler_object->template);
    ...
    {
        return $this->cached_filepath === null ? $this->cached_filepath = ($this->resource_object->isEvaluated || ! ($this->caching == Smarty::CACHING_LIFETIME_CURRENT || $this->caching == Smarty::CACHING_LIFETIME_SAVED)) ? false : $this->cache_resource_object->getCachedFilepath($this) : $this->cached_filepath;
    }
    ...
    {
        return $this->cached_timestamp === null ? $this->cached_timestamp = ($this->resource_object->isEvaluated || ! ($this->caching == Smarty::CACHING_LIFETIME_CURRENT || $this->caching == Smarty::CACHING_LIFETIME_SAVED)) ? false : $this->cache_resource_object->getCachedTimestamp($this) : $this->cached_timestamp;
    }
    ...
    {
        return $this->rendered_content === null ? $this->rendered_content = ($this->resource_object->isEvaluated || ! ($this->caching == Smarty::CACHING_LIFETIME_CURRENT || $this->caching == Smarty::CACHING_LIFETIME_SAVED)) ? false : $this->cache_resource_object->getCachedContents($this) : $this->rendered_content;
    }
     ...
     * @param object $resource_handler
     *            return resource handler object
     */
    ...
    public function buildTemplateFilepath($file = null)
    {
        ...
        if (! empty($this->smarty->default_template_handler_func)) {
            if (! is_callable($this->smarty->default_template_handler_func)) {
                ...
                $_return = call_user_func_array($this->smarty->default_template_handler_func, array(
                    $this->resource_type,
                    $this->resource_name,
